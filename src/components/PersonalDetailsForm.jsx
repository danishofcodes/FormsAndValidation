import { faCheckCircle, faCircleExclamation, faRotateRight } from '@fortawesome/free-solid-svg-icons'
            ...
            {confirmResetModal &&
                <div className='backdrop'>
                    <div className='modal-confirm-action'>
                        <h5>the form will be reset, all data will be lost, want to proceed? </h5>
